...
public class Codes {
    ...
    public final static int REQUEST_MANIFEST = 10;
    public final static int REQUEST_FILE = 11;
    ...
    public final static String[] COUNTRY_NAMES = new String[] {
        ...
        "Algeria", "Burkina Faso", "Angola", "Benin", "Botswana", "Burundi", "Camaroon", "Central African Republic", "Chad", 
        ...
        "Venezuela", "Austria", "Togo", "Tunisia"
    };
}
